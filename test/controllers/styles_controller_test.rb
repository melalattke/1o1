...
class StylesControllerTest < ActionController::TestCase
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post :create, style: { day: @style.day, difficulty: @style.difficulty, name: @style.name, time: @style.time }
    end
  ...
  test "should update style" do
    patch :update, id: @style, style: { day: @style.day, difficulty: @style.difficulty, name: @style.name, time: @style.time }
    assert_redirected_to style_path(assigns(:style))
  end
